...
> "I want to build a web app for [user]. The main thing it does is [core function]. It should have [feature 1], [feature 2], and [feature 3]. Keep it simple - we have 90 minutes. Use the Base Design System from docs/DESIGN.md."
