...
- [x] Build the app shell — full-screen split layout with a styled header, step tabs (1. Review / 2. Draft LBA / 3. Advice Note), left doc panel + right task panel
...
- **Deployment question for real day:** trainees won't have their own API keys — consider a simple proxy or pre-configured key for the event
